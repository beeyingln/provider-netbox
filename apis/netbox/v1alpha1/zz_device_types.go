...
type DeviceParameters struct {
	...
	DeviceTypeID *float64 `json:"deviceTypeId" tf:"device_type_id,omitempty"`
	...
	// +kubebuilder:validation:Required
	RoleID *float64 `json:"roleId" tf:"role_id,omitempty"`

	// +kubebuilder:validation:Optional
	Serial *string `json:"serial,omitempty" tf:"serial,omitempty"`

	// +kubebuilder:validation:Required
	SiteID *float64 `json:"siteId" tf:"site_id,omitempty"`
